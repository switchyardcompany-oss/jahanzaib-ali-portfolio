      ...
      <div className="container mx-auto py-36 text-center xl:text-left flex flex-col items-center justify-center xl:h-full gap-y-10 xl:py-32">
        <div className="flex flex-col w-full max-w-175">
          ...
          <motion.div
            ...
            animate="show"
            exit="hidden"
            className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-12 text-sm text-white/70"
          >
            <a
              href="mailto:juttbroo1122@gmail.com"
              className="hover:text-accent transition-all duration-300"
            >
              juttbroo1122@gmail.com
            </a>
            <a
              href="tel:+923227483975"
              className="hover:text-accent transition-all duration-300"
            >
              +92 322 7483975
            </a>
            <a
              href="https://wa.me/923227483975"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/jahanzaib-ali-5b7170300/"
              target="_blank"
              rel="noreferrer noopener"
              className="hover:text-accent transition-all duration-300"
            >
            ...
            <a
              href="https://www.facebook.com/jahanzaibaliwp"
              target="_blank"
              rel="noreferrer noopener"
              className="hover:text-accent transition-all duration-300"
            >
        ...
        <p className="text-xs text-white/40">
          © {new Date().getFullYear()} Jahanzaib Ali. All rights reserved.
        </p>
      </div>
    </div>
  );
